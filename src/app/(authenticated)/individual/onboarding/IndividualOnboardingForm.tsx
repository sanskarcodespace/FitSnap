...
import { upsertIndividualProfile } from "./actions"
...
export function IndividualOnboardingForm({ initialData = {} }: { initialData?: any }) {
  ...
  const handleNext = async () => {
    ...
    try {
      ...
      const saveRes = await upsertIndividualProfile(payload)
  ...
  const handleFinish = async () => {
    ...
    try {
      ...
      const saveRes = await upsertIndividualProfile({
    ...
    <div className="space-y-6">
      ...
      {step === 4 && (
        <div className="space-y-4 animate-in fade-in">
          ...
          <p className="text-[var(--text-body-sm-size)] text-[var(--color-neutral-600)]">Optional. Personalize your profile.</p>
