...
import { fetchCoachNutritionHistory } from "./actions"
import type { NutritionHistorySummary } from "@/lib/data/nutrition"
import { Select } from "@/components/ui/select"

export function CoachFoodHistoryTab({ clientId }: { clientId: string }) {
  ...
  const fetchData = (start: string, end: string) => {
    ...
    startTransition(async () => {
      try {
        const result = await fetchCoachNutritionHistory(clientId, start, end)
        setData(result)
      } catch (err: any) {
