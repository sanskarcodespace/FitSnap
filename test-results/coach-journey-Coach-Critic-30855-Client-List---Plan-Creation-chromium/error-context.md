...
ConnectorError(ConnectorError { user_facing_error: None, kind: QueryError(PostgresError { code: "40P01", message: "deadlock detected", severity: "ERROR", detail: Some("Process 10264 waits for RowExclusiveLock on relation 16996 of database 16971; blocked by process 10265.\nProcess 10265 waits for AccessExclusiveLock on relation 16986 of database 16971; blocked by process 10264."), column: None, hint: Some("See server log for query details.") }), transient: false })
```
